...
def CreaSubcarpetas(dir: str, id: str, cMap: pd.DataFrame):
...
def AlmacenaResultados(df: pd.DataFrame, icm: pd.DataFrame, route: str, ids: str, raw: bool, cMap: pd.DataFrame):
